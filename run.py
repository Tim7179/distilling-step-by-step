...
from data_utils import (
    CQADatasetLoader, SVAMPDatasetLoader, ESNLIDatasetLoader, 
    ANLI1DatasetLoader, ASDivDatasetLoader, OpenR1Math220kDatasetLoader
)
...
def run(args):
    ...
    elif args.dataset == 'OpenR1-Math-220k':
        dataset_loader = OpenR1Math220kDatasetLoader()
    elif args.dataset == 'hendrycks_math':
        from data_utils import HendrycksMathDatasetLoader
        dataset_loader = HendrycksMathDatasetLoader()
    else:
        raise ValueError
